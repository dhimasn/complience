            ...
            <div class="container container-login container-transparent animated fadeIn">
                ...
                <div class="login-form">
                    <div class="form-group">
                        <input id="username" name="username" autocomplete="off" type="text" placeholder="Email" class="form-control"
                            required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group text-center d-grid">
                        ...
                        <button href="#" class="btn btn-yellow button-pilih-formulir-dash">Masuk</button>
                    </div>
                </div>
            </div>
        </div>
